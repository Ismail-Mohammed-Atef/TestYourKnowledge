...
namespace TestYourKnowledge.Migrations
{
    ...
    [Migration("20250101071351_updateusers5")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UserAnswersHistoryUsers", b =>
                {
                    b.Property<int>("UserHistoryId")
                        .HasColumnType("int");

                    b.Property<int>("UsersOfExamId")
                        .HasColumnType("int");

                    b.HasKey("UserHistoryId", "UsersOfExamId");

                    b.HasIndex("UsersOfExamId");

                    b.ToTable("UserAnswersHistoryUsers");
                });
            ...
            modelBuilder.Entity("UserAnswersHistoryUsers", b =>
                {
                    ...
                    b.HasOne("TestYourKnowledge.Models.Users", null)
                        .WithMany()
                        .HasForeignKey("UsersOfExamId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
